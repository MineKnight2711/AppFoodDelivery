...
import 'package:app_food_2023/widgets/deliver/confirm_delivery.dart';
...
import '../../../../widgets/deliver/delivery_order_details_list_dish.dart';
import '../../../admin/order_manager/order_class.dart';

class OnDeliverOrderDetailsScreen extends StatelessWidget {
  final OrderData orderData;

  OnDeliverOrderDetailsScreen({required this.orderData});
                ...
                showDialog(
                  ...
                  builder: (context) {
                    return ConfirmDeliveryDialog(
                      onConfirm: () async {
                        await controller.confirmDeliverySuceedOrder();
                        Navigator.of(context).pop();

                        CustomSnackBar.showCustomSnackBar(
                            context, 'Đã giao thành công!', 2,
