...
class VoucherDatePickerWidget extends StatefulWidget {
  final DateTime? initialDate;
  final ValueChanged<DateTime>? onChanged;

  VoucherDatePickerWidget({this.initialDate, this.onChanged});

  @override
  _VoucherDatePickerWidgetState createState() =>
      _VoucherDatePickerWidgetState();
}

class _VoucherDatePickerWidgetState extends State<VoucherDatePickerWidget> {
